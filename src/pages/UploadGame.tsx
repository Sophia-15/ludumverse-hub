  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Arquivo verificado e salvo com sucesso. Agora você pode publicar o jogo.",
      });
    } catch (error) {
      toast({
        ...
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Envie o arquivo .zip do seu jogo. Após a verificação de segurança, 
              você poderá adicionar as informações e publicá-lo.
            </p>
          </div>
          ...
          <Card className="p-8 bg-card/50 backdrop-blur-sm">
            {!uploadComplete ? (
              <>
                {/* Upload Area */}
                <div className="mb-8">
                  <Label htmlFor="game-file" className="text-base font-semibold mb-4 block">
                    Arquivo do Jogo
                  </Label>
                  <div
                ...
                <Card className="p-6 bg-gradient-hero border-primary/20 mb-6">
                  <h3 className="font-bold text-lg mb-4">Requisitos do Pacote</h3>
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                      <span>Arquivo .zip único contendo todos os arquivos do jogo</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                      <span>Nome do arquivo seguindo a convenção: game-name-version.zip</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                      <span>Manifesto de estrutura incluído (manifest.json)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>Será realizada verificação automática de malware</span>
                    </li>
                  </ul>
                </Card>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground mb-8 max-w-md mx-auto">
                  Seu jogo foi enviado e verificado com sucesso. 
                  Agora você pode adicionar as informações e publicá-lo na plataforma.
                </p>
