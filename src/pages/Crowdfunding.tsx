      ...
      <section className="bg-gradient-hero border-b border-border/50 py-12 px-4">
        <div className="container mx-auto">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Apoie desenvolvedores indie e ajude a tornar jogos incríveis realidade. 
            Se a meta não for atingida, seu dinheiro volta para sua carteira automaticamente.
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <Card className="p-6 bg-card/50 backdrop-blur-sm text-center">
            <div className="text-3xl font-bold text-primary mb-2">
              R$ {mockCampaigns.reduce((sum, c) => sum + c.currentAmount, 0).toLocaleString('pt-BR')}
            </div>
            <div className="text-muted-foreground">Arrecadado</div>
          </Card>
          <Card className="p-6 bg-card/50 backdrop-blur-sm text-center">
            <div className="text-3xl font-bold text-secondary mb-2">
              {mockCampaigns.reduce((sum, c) => sum + c.backers, 0).toLocaleString('pt-BR')}
            </div>
              ...
              >
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                    <h3 className="text-white text-2xl font-bold">{campaign.title}</h3>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="flex items-center gap-2 text-muted-foreground">
                      ...
                      <div>
                        <p className="font-semibold text-foreground">{campaign.backers}</p>
                    ...
                    <div className="flex items-center gap-2 text-muted-foreground">
                      ...
                      <div>
                        <p className="font-semibold text-foreground">{campaign.daysLeft} dias</p>
                  ...
                  {/* Rewards Preview */}
                  <div className="mb-6">
                    <p className="text-sm font-medium mb-3">Recompensas disponíveis:</p>
        ...
        <Card className="mt-12 p-6 bg-gradient-hero border-primary/20">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg mb-2">Como funciona o Crowdfunding?</h3>
              <ul className="space-y-2 text-muted-foreground text-sm">
                <li>• Escolha uma campanha e selecione uma recompensa</li>
                <li>• Seu dinheiro fica bloqueado até o fim da campanha</li>
                <li>• Se a meta for atingida, o desenvolvedor recebe os fundos em 24h</li>
                <li>• Se a meta não for atingida, você recebe reembolso automático na carteira</li>
